          ...
          <div className='w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5'>
            ...
            <div className='flex flex-wrap gap-2'>
              {emailsToInvite.map(email => {
                return (
                  <div key={email} className='bg-zinc-800 text-zinc-300 px-2.5 py-1.5 rounded-lg flex items-center gap-2'>
                    {email}
            ...
            <form onSubmit={addNewEmailToInvite} className='p-2.5 bg-zinc-950 border border-zinc-800 rounded-lg flex items-center gap-2'>
              <div className='px-2 flex items-center flex-1 gap-2'>
                ...
                <input 
                  ...
                  className="bg-transparent text-zinc-300 outline-none px-3 py-2 rounded-lg flex-1"
                />
              </div>
              <button type='submit' className='bg-lime-300 text-lime-950 rounded-lg px-3 py-2 font-medium hover:bg-lime-400 flex items-center gap-2'>
                Convidar
